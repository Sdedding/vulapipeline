...
class PeerDetailsOverlay(tk.Toplevel):
    ...
    def __init__(self, parent: tk.Frame, peer: Peer) -> None:
        tk.Toplevel.__init__(self, parent)
        self.app = parent
        self.peer = peer

        self.id = peer.id
        self.name = peer.name or (peer.other_names or "")
    ...
    def pin_verify(self) -> None:
        ...
        self.data.verify_and_pin_peer(self.peer.id, name)
    ...
    def add_additional_ip(self) -> None:
        ...
        try:
            self.data.peer_addr_add(self.peer.id, self.entry_additional_ip.get())
